            ...
            <div className="p-8 relative flex-1 flex flex-col">
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex flex-col items-end">
                  <span className="text-xl font-light text-white/80">${product.price.toLocaleString()}</span>
                  <span className="text-[10px] font-bold text-white/20 uppercase tracking-widest">{product.currency}</span>
                </div>
              </div>
              ...
              <div className="mt-auto flex items-center gap-2 text-xs font-bold text-white uppercase tracking-widest group-hover:text-bieneq-green transition-colors group/btn">

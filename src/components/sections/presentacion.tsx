            ...
            >
              ...
              <div className="relative w-full md:w-[45%] h-64 md:h-auto overflow-hidden bg-zinc-800 shrink-0">
                 ...
                 <div className="absolute top-8 left-8 pointer-events-none">
                    <span className="font-mono text-8xl md:text-[12rem] font-black text-white/[0.03] leading-none select-none">
                      {String(selectedTopic?.index || selectedQuestion?.index).padStart(2, "0")}
                    </span>
                 </div>
              </div>

              {/* Text side */}
              <div className="flex-1 p-8 md:p-16 flex flex-col justify-center gap-6 md:gap-8 relative z-10">
                 <div className="space-y-4">
                    ...
                    >
                       ...
                       <span className="text-amber-500 font-mono text-[10px] uppercase tracking-[0.4em] font-black">
                         {selectedTopic ? "Módulo del Curso" : "Dinámica de Grupo"}
                       </span>
                    </motion.div>

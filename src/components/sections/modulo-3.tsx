...
export function Modulo3() {
  ...
  return (
    <section id="modulo-3" className="min-h-screen py-20 px-6 lg:px-16 bg-white flex flex-col justify-center border-t border-slate-100">
      <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.6 }} className="max-w-6xl">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="prose prose-lg text-muted-foreground text-lg leading-relaxed">
            ...
            <div className="bg-slate-50 p-8 rounded-xl mt-10 text-foreground font-medium shadow-inner border border-slate-100 text-xl">
              ...
              <span className="text-slate-600 italic">El movimiento es el motor del crecimiento y la salud del casco.</span>
            </div>
          </div>

          <div className="bg-primary/5 rounded-3xl p-10 border border-primary/20 shadow-lg">
